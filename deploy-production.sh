...
echo "  - Frontend: https://afoodzone.com"
echo "  - API: https://api.afoodzone.com"
echo "  - Cookie Domain: .afoodzone.com"
...
echo "3. Configure DNS to point api.afoodzone.com to your backend"
