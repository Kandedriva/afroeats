  ...
  const fetchReports = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/owners/reports?range=${timeRange}`,
        { credentials: 'include' }
      );
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Track your restaurant performance and sales</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <span className="mr-2">🏆</span> Top Selling Dishes
                </h2>
                {stats.topDishes && stats.topDishes.length > 0 ? (
                      ...
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">{dish.total_sold} units sold</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-orange-600">${dish.revenue.toFixed(2)}</p>
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p>No dish data available for this period</p>
                  </div>
                )}
              </div>
