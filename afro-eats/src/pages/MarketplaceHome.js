...
const MarketplaceHome = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-green-50 mt-16 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">
            Looking for Restaurant Food?
          </h2>
          <p className="text-lg text-gray-600 mb-6">
            Order delicious African cuisine from our restaurant partners
          </p>
          <Link
            to="/"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Partner with Order Dabaly
            </h2>
            <p className="text-lg text-gray-600">
              Join our growing network of African food businesses
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Restaurant Owner Registration */}
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-8 border-2 border-orange-200 hover:border-orange-400 transition-all">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  List your restaurant and reach thousands of customers craving authentic African cuisine
                </p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✓</span>
                  <span className="text-gray-700">Easy online ordering system</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✓</span>
            ...
            {/* Grocery Store Owner Registration */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-8 border-2 border-green-200 hover:border-green-400 transition-all">
              <div className="text-center mb-6">
                <div className="text-6xl mb-4">🛒</div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">
                ...
                <p className="text-gray-600 mb-6">
                  Sell your African groceries online and expand your customer base across the city
                </p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✓</span>
                  <span className="text-gray-700">Inventory management tools</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✓</span>
                  <span className="text-gray-700">Product catalog with photos</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✓</span>
                  <span className="text-gray-700">Order tracking and delivery</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✓</span>
                  <span className="text-gray-700">Sales reports and analytics</span>
                </li>
              </ul>
              <Link
