      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl font-bold">🍽️ All Restaurants</h1>
          </div>
      ...
      {restaurants.length > 0 && (
        <div className="bg-green-50 py-16 mt-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              Looking for Fresh Ingredients?
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Shop our marketplace for authentic African produce, spices, and cooking ingredients
            </p>
            <Link
              to="/marketplace"
              className="inline-block px-8 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-semibold text-lg"
