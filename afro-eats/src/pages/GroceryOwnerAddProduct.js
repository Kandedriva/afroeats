...
function GroceryOwnerAddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/grocery-owners/products`, {
        method: 'POST',
        credentials: 'include',
        body: formDataToSend,
      });
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <p className="text-gray-600 mt-2">Add a new product to your store inventory</p>
        </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Upload a product photo (JPG, PNG, max 5MB)
                  </p>
                </div>
              </div>
            </div>
...
export default GroceryOwnerAddProduct;
